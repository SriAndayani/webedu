          ...
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu rounded-0 m-0">
                <a href="blog.html" class="dropdown-item">Frontend</a>
                <a href="single.html" class="dropdown-item">Backend</a>
                <a href="single.html" class="dropdown-item">UI/UX Design</a>
              </div>
            </div>
            <a href="contact.html" class="nav-item nav-link">Contact</a>
          </div>
          <a href="akses/login.php" class="btn btn-primary px-4">Login</a>
        </div>
      </nav>
    </div>
    <!-- Navbar End -->
        ...
        <div class="row">
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              ...
              <a href="" class="btn btn-primary px-4 mx-auto mb-4">Start</a>
            </div>
          </div>
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
